...
wishlist_package.insert_wishlist(customer_id INT, book_id INT) AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE 
wishlist_package.insert_recommendations(customer_id INT, book_id INT) AS $$
BEGIN
...
--function called inside trigger (login pg)
