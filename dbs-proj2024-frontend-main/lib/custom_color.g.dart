...
const customcolor1 = Color(0xFF7FD47A);


CustomColors lightCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF7FD47A),
  customcolor1: Color(0xFF166D21),
  onCustomcolor1: Color(0xFFFFFFFF),
  customcolor1Container: Color(0xFFA0F799),
  onCustomcolor1Container: Color(0xFF002203),
);

CustomColors darkCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF7FD47A),
  customcolor1: Color(0xFF85DA7F),
  onCustomcolor1: Color(0xFF003909),
  customcolor1Container: Color(0xFF005311),
  onCustomcolor1Container: Color(0xFFA0F799),
);
