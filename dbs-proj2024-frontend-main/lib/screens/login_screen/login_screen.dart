          ...
          child: BlocProvider(
            ...
            child: BlocConsumer<LoginScreenBloc, LoginScreenState>(
              listener: (context, state) {
                switch (state) {
                  case DisplayLoadingSnackBarActionState _:
                    ...
                    break;
                  case DisplayInvalidUnamePwdSnackBarActionState _:
                    const snackBar = SnackBar(
                      content: Row(
                        children: [
                          Icon(
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(snackBar);
                    break;
                  case DisplayHomeScreenActionState _:
                    ...
                    break;
                  case CustomerCreationNotSuccessfulActionState _:
                    const snackBar = SnackBar(
                      content: Row(
                        children: [
                          Icon(
