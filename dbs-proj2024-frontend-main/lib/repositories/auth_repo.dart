...
class AuthRepo {
  ...
  static Future<http.Response> createCustomer(
    ...
    final url = Uri.parse('https://bookstore-management-system-3lku.onrender.com/customers/');
  ...
  static Future<http.Response> verifyCustomer(
    ...
    final url = Uri.parse(
        'https://bookstore-management-system-3lku.onrender.com/customer-auth/$uname/$passwd');
